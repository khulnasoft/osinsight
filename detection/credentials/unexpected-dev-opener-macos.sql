...
WHERE
  ...
  AND exception_key NOT IN (
    ...
    '/dev/auditpipe,osinsightd,Developer ID Application: OSINSIGHT A Series of LF Projects, LLC (3522FA9PXF),io.osinsight.agent',
    '/dev/auditpipe,osinsightd,Developer ID Application: OSINSIGHT A Series of LF Projects, LLC (3522FA9PXF),osinsightd',
